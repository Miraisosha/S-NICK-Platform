...
各画面のPC・タブレット・スマートフォン配置は画面レイアウト設計で定める。共通の文字、ボタン、余白および配色は [Squash Platform UIデザインガイド](UiDesignGuide.md) を参照する。

代表的なレスポンシブ構成は、[運営者画面の初期デザイン案](UiDesignGuide.md#9-運営者画面の初期デザイン案)を参照する。
