...
複数の利用者・機能に共通する要件を管理する。画面固有またはイベント固有の業務ルールは、所有する機能グループに記載する。

## 機能一覧

| 番号 | 機能 | 資料 |
|---|---|---|
| 9010 | 利用者・権限 | [9010_user_roles.md](9010_user_roles.md) |
| 9101 | 共通API | [9101_api.md](9101_api.md) |
...
| 9702 | ライブ配信 | [9702_live_streaming.md](9702_live_streaming.md) |
| 9801 | マニュアル・QA | [9801_manual_qa.md](9801_manual_qa.md) |

イベント問い合わせは共通問い合わせとして扱わず、[運営者のイベント問い合わせ](../2000_operator/2370_event_inquiries.md)を正本とする。
