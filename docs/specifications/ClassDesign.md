...
- データ構造：[`DataModel.md`](DataModel.md)
- 画面遷移：[`ScreenFlow.md`](ScreenFlow.md)
...
6. 試合状態遷移は[`yaml/state-machine.yaml`](yaml/state-machine.yaml)を正本とし、クラス内に別の状態一覧を持たない。
