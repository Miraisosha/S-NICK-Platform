...
S-NICK Platformは、スカッシュ大会の企画、運営、試合進行、スコア管理、ライブ配信、結果公開までを一元的に支援する統合プラットフォームです。
...
| 利用者 | 主な利用内容 | 状態 |
|---|---|---|
| 一般ユーザー | ユーザー登録、ログイン、タイトル閲覧 | 構想あり |
| 参加者・選手 | エントリー、通知確認、ドロー・試合状況確認 | 構想あり |
| 運営 | タイトル、カテゴリ、選手、ドロー、試合の管理 | 構想あり |
| スタッフ | 招待されたタイトルの運営業務 | 構想あり |
